class Visitor < ActiveRecord::Base
  ...
  IMAGE_LABELS = ['Local partners to generate new leads and sales', 'Use partners to close leads you can\'t close yourself', 'Local consultants to provide after sales implementation, training and support services']
